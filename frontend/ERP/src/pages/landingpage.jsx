    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900 selection:text-indigo-900 dark:selection:text-indigo-100">
            ...
            <section className="relative pt-44 pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <div className="mt-24 relative max-w-6xl mx-auto animate-in fade-in zoom-in-95 duration-1000 delay-500">
                        <div className="absolute -inset-1 bg-linear-to-r from-indigo-500 to-purple-500 rounded-[32px] blur opacity-20 dark:opacity-40" />
            ...
            <section className="py-32 bg-white dark:bg-slate-950 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="bg-indigo-600 dark:bg-indigo-700 rounded-[48px] p-12 md:p-24 text-white relative overflow-hidden">
            ...
            <section className="py-32 bg-white dark:bg-slate-950">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link to="/dashboard" className="bg-indigo-600 text-white px-10 py-5 rounded-2xl text-xl font-bold hover:bg-indigo-700 hover:scale-105 transition-all shadow-2xl shadow-indigo-200 dark:shadow-indigo-900/40">
                            Start Free Trial
                        </Link>
                        <Link to="/dashboard" className="border-2 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 px-10 py-5 rounded-2xl text-xl font-bold hover:bg-slate-50 dark:hover:bg-slate-900 transition-all">
                            Talk to an Expert
                        </Link>
                    </div>
