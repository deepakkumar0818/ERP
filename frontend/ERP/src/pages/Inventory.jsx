        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Monitor stock levels and warehouse operations.</p>
                </div>
                <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 rounded-xl font-semibold hover:bg-slate-50 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                    ...
                    <p className="text-3xl font-bold text-slate-900 mt-1">1,280</p>
                </div>
                ...
                <div className="p-4 border-b border-slate-50 flex flex-col md:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2 w-full border-slate-200 rounded-lg focus:ring-2 focus:ring-indigo-500 transition-all"
                        />
                    </div>
                    <div className="flex gap-2">
                        <select className="px-3 py-2 border-slate-200 rounded-lg text-sm bg-slate-50">
                            ...
                            {items.map((item, i) => (
                                <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-[10px] text-slate-400 font-mono">SKU-8923-01</div>
                                    </td>
                                    ...
                                    <td className="px-6 py-4 text-sm text-slate-500">{item.min} {item.unit}</td>
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-0.5 rounded-full text-xs font-medium border ${item.status === 'In Stock' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' :
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button className="text-indigo-600 hover:text-indigo-800 font-medium text-sm">Update</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
